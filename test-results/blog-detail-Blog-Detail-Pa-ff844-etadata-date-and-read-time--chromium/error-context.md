...
Error: strict mode violation: locator('.text-foreground\\/60') resolved to 23 elements:
    1) <p class="text-foreground/60">Loading...</p> aka getByText('Loading...')
    2) <p class="text-foreground/60 mb-4 max-w-md">Transform your digital presence with expert web d…</p> aka getByText('Transform your digital')
    ...
    4) <a href="/en/about" class="text-foreground/60 hover:text-foreground transition-colors">About</a> aka getByRole('contentinfo').getByRole('link', { name: 'About' })
    5) <a href="/en/portfolio" class="text-foreground/60 hover:text-foreground transition-colors">Portfolio</a> aka getByRole('contentinfo').getByRole('link', { name: 'Portfolio' })
    6) <a href="/en/pricing" class="text-foreground/60 hover:text-foreground transition-colors">Pricing</a> aka getByRole('contentinfo').getByRole('link', { name: 'Pricing' })
    7) <a href="/en/blog" class="text-foreground/60 hover:text-foreground transition-colors">Blog</a> aka getByRole('contentinfo').getByRole('link', { name: 'Blog' })
    8) <a href="/en/contact" class="text-foreground/60 hover:text-foreground transition-colors">Contact</a> aka getByRole('contentinfo').getByRole('link', { name: 'Contact' })
    9) <a href="/en/legal/privacy" class="text-foreground/60 hover:text-foreground transition-colors">Privacy Policy</a> aka getByRole('link', { name: 'Privacy Policy' })
    10) <a href="/en/legal/terms" class="text-foreground/60 hover:text-foreground transition-colors">Terms of Service</a> aka getByRole('link', { name: 'Terms of Service' })
    ...
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e37]:
    - generic [ref=e39]:
      - article [ref=e40]:
        - generic [ref=e43]:
          - link "Back to Blog" [ref=e44] [cursor=pointer]:
            - /url: /en/blog
            - img [ref=e45]
            - text: Back to Blog
      ...
      - generic [ref=e132]:
        ...
        - link "Web Design How to Build a Conversion-Optimized Landing Page Master the art of creating landing pages that convert with our comprehensive guide covering design, copy, and optimization." [ref=e135] [cursor=pointer]:
    ...
    - generic [ref=e153]:
      - generic [ref=e154]:
        ...
        - generic [ref=e180]:
          ...
          - generic [ref=e182]:
            - link "Follow us on Twitter/X" [ref=e183] [cursor=pointer]:
              - /url: https://twitter.com/elevatedigital
              - img [ref=e184]
            - link "Follow us on LinkedIn" [ref=e186] [cursor=pointer]:
              - /url: https://linkedin.com/company/elevatedigital
              - img [ref=e187]
            - link "Follow us on Instagram" [ref=e189] [cursor=pointer]:

...
Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'Services' }) resolved to 3 elements:
    1) <a href="/services" class="text-foreground/80 hover:text-foreground transition-colors hover:scale-105 transform inline-block">Services</a> aka getByRole('navigation').getByRole('link', { name: 'Services' })
    2) <a href="/services" class="px-8 py-4 border-2 border-foreground/20 rounded-full font-semibold text-lg hover:border-primary hover:text-primary transition-all text-center">Explore Services</a> aka getByRole('link', { name: 'Explore Services' })
    3) <a href="/services" class="text-foreground/60 hover:text-foreground transition-colors">Services</a> aka getByRole('contentinfo').getByRole('link', { name: 'Services' })
  ...
  - main [ref=e14]:
    - generic [ref=e15]:
      - generic [ref=e19]:
        ...
        - generic [ref=e22]:
          - link "Start Your Project" [ref=e23]:
            - /url: /contact
          - link "Explore Services" [ref=e24]:
            - /url: /services
      - generic [ref=e26]:
        - generic [ref=e28]:

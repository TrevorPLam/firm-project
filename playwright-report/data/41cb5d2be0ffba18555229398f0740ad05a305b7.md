...
- Name: blog-detail.spec.ts >> Blog Detail Page >> should display post metadata (date and read time)
- Location: app\e2e\blog-detail.spec.ts:33:7
...
Locator: locator('.text-foreground\\/60')
Expected substring: "July 10, 2026"
Error: strict mode violation: locator('.text-foreground\\/60') resolved to 22 elements:
    1) <a href="/en/blog" class="text-foreground/60 hover:text-foreground mb-8 inline-flex items-center gap-2 transition-colors">…</a> aka getByRole('link', { name: 'Back to Blog' })
    2) <div class="text-foreground/60 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">…</div> aka getByText('DPDavid ParkUI/UX Designer•July 10, 2026•5 min readShare:')
    3) <span class="text-foreground/60 text-sm font-medium">Share:</span> aka getByText('Share:')
    4) <button tabindex="0" aria-label="Share on Twitter/X" class="text-foreground/60 hover:text-foreground transition-colors">…</button> aka getByRole('button', { name: 'Share on Twitter/X' })
    5) <button tabindex="0" aria-label="Share on Facebook" class="text-foreground/60 hover:text-foreground transition-colors">…</button> aka getByRole('button', { name: 'Share on Facebook' })
    6) <button tabindex="0" aria-label="Share on LinkedIn" class="text-foreground/60 hover:text-foreground transition-colors">…</button> aka getByRole('button', { name: 'Share on LinkedIn' })
    7) <button tabindex="0" aria-label="Share via email" class="text-foreground/60 hover:text-foreground transition-colors">…</button> aka getByRole('button', { name: 'Share via email' })
    8) <div class="text-foreground/60 flex items-center gap-2 text-sm">…</div> aka getByText('Expertise:Digital Marketing')
    9) <p class="text-foreground/60 text-sm">Master the art of creating landing pages that con…</p> aka getByRole('link', { name: 'Web Design How to Build a' })
    10) <p class="text-foreground/60 mb-4 max-w-md">Transform your digital presence with expert web d…</p> aka getByText('Transform your digital')
    ...

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.text-foreground\\/60')
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e10]:
    - generic [ref=e12]:
      - article [ref=e13]:
        - generic [ref=e16]:
          - link "Back to Blog" [ref=e17] [cursor=pointer]:
            - /url: /en/blog
            - img [ref=e18]
            - text: Back to Blog
      ...
      - generic [ref=e105]:
        ...
        - link "Web Design How to Build a Conversion-Optimized Landing Page Master the art of creating landing pages that convert with our comprehensive guide covering design, copy, and optimization." [ref=e108] [cursor=pointer]:
    ...
    - generic [ref=e126]:
      - generic [ref=e127]:
          ...
          - list [ref=e133]:
            ...
            - listitem [ref=e136]:
              - link "About" [ref=e137] [cursor=pointer]:
                - /url: /en/about
            - listitem [ref=e138]:
              - link "Portfolio" [ref=e139] [cursor=pointer]:
                - /url: /en/portfolio
            - listitem [ref=e140]:
        ...
        - generic [ref=e153]:
          ...
          - generic [ref=e155]:
            - link "Follow us on Twitter/X" [ref=e156] [cursor=pointer]:
              - /url: https://twitter.com/elevatedigital
              - img [ref=e157]
            - link "Follow us on LinkedIn" [ref=e159] [cursor=pointer]:
              - /url: https://linkedin.com/company/elevatedigital
              - img [ref=e160]
            - link "Follow us on Instagram" [ref=e162] [cursor=pointer]:

...
- Name: portfolio-detail.spec.ts >> Portfolio Detail Page >> should display results metrics
- Location: app\e2e\portfolio-detail.spec.ts:21:7
...
Expected: visible
Error: strict mode violation: getByText('150%') resolved to 3 elements:
    1) <p class="text-foreground/70 mb-8 text-xl leading-relaxed md:text-2xl">Complete e-commerce website redesign resulting in…</p> aka getByText('Complete e-commerce website')
    2) <div class="text-primary mb-2 text-5xl font-bold">150%</div> aka getByText('150%', { exact: true })
    3) <p class="text-foreground/90 mb-6 text-2xl leading-relaxed">…</p> aka getByText('"Elevate Digital transformed')
    ...
    - generic [ref=e109]:
      - generic [ref=e110]:
        ...
        - generic [ref=e114]:
          ...
          - list [ref=e116]:
            - listitem [ref=e117]:
              - link "Services" [ref=e118]:
                - /url: /en/services
            - listitem [ref=e119]:
              - link "About" [ref=e120]:
                - /url: /en/about
            - listitem [ref=e121]:
              - link "Portfolio" [ref=e122]:
                - /url: /en/portfolio
            - listitem [ref=e123]:
        ...
        - generic [ref=e129]:
          ...
          - list [ref=e131]:
            ...
            - listitem [ref=e134]:
              - link "Terms of Service" [ref=e135]:
                - /url: /en/legal/terms
        - generic [ref=e136]:
          - heading "Follow Us" [level=4] [ref=e137]
          - generic [ref=e138]:
            - link "Follow us on Twitter/X" [ref=e139]:
              - /url: https://twitter.com/elevatedigital
              - img [ref=e140]
            - link "Follow us on LinkedIn" [ref=e142]:
              - /url: https://linkedin.com/company/elevatedigital
              - img [ref=e143]
            - link "Follow us on Instagram" [ref=e145]:

...
Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'Services' }) resolved to 2 elements:
    ...
    2) <a href="/en/services" class="text-foreground/60 hover:text-foreground transition-colors">Services</a> aka getByRole('contentinfo').getByRole('link', { name: 'Services' })

...
export const metadata: Metadata = {
  ...
  description:
    "Meet the talented team at Elevate Digital. Our experts specialize in web design, SEO, analytics, and digital marketing strategies.",
  keywords: [
    "our team",
    "meet the team",
    "digital agency team",
            ...
            {teamMembers.map((member, index) => (
              <ScrollReveal key={member.id} delay={index * 100}>
                <div className="bg-background border-foreground/10 hover:border-primary/50 overflow-hidden rounded-2xl border transition-all hover:shadow-xl">
                  <div className="from-primary/10 to-primary/5 flex aspect-square items-center justify-center bg-gradient-to-br">
                    {member.image ? (
                      <Image
                        src={member.image}
                        alt={member.name}
                  ...
                  <div className="p-8">
                    ...
                    <div className="mb-6">
                      <h4 className="mb-3 text-sm font-semibold">Expertise:</h4>
          ...
          <ScrollReveal>
            <div className="mx-auto mb-16 max-w-3xl text-center">
              ...
              <p className="text-foreground/70 text-xl leading-relaxed">
                We believe in continuous learning, collaboration, and pushing
            ...
            {[
              {
                ...
                description:
                  "We stay ahead of industry trends through regular training, conferences, and knowledge sharing sessions.",
                icon: (
                  <svg
                    className="h-6 w-6"
                    fill="none"
              ...
              },
              {
                title: "Collaboration",
                description:
                  "We work together across disciplines to deliver integrated solutions that exceed client expectations.",
                icon: (
                  <svg
                    className="h-6 w-6"
                    fill="none"
              ...
              },
              {
                title: "Innovation",
                description:
                  "We experiment with new technologies and approaches to find better solutions for our clients.",
                icon: (
                  <svg
                    className="h-6 w-6"
                    fill="none"
        ...
        <div className="mx-auto max-w-4xl text-center">
          <ScrollReveal>
            ...
            <p className="text-foreground/70 mb-8 text-xl">
              ...
              about digital marketing. Check out our open positions.
            </p>
            <Link
              href="/contact"

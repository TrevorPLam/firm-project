// Blog data module - single source of truth for blog content
// DDD: Blog content is a bounded context; defined once in domain module
...
// Topic cluster mapping for summary views
const topicClusters: Record<string, string> = {
  "web-design-trends-2025": "web-design",
  "local-seo-guide": "seo",
  "core-web-vitals": "analytics",
  "conversion-landing-pages": "web-design",
  "ai-digital-marketing": "digital-marketing",
  "content-strategy-2025": "content-strategy",
};

/**
 * Get all blog posts as summary view (for list page)
 */

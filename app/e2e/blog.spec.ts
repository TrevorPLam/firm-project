...
test.describe('Blog List Page', () => {
  test('should render blog list with post titles and categories', async ({ page }) => {
  ...
  test('should display post metadata (date and read time)', async ({ page }) => {
    await page.goto('/en/blog');
  ...
  test('should display topic clusters section', async ({ page }) => {
    ...
    const topicHeading = page.getByRole('heading', { name: 'Explore by Topic' });

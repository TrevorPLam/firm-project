  ...
  if (locale === "en") {
    return (
      ...
      >
        ...
        <path
          d="M0 37h640v37H0zM0 111h640v37H0zM0 185h640v37H0zM0 259h640v37H0zM0 333h640v37H0zM0 407h640v37H0z"
          fill="#fff"
        />
  ...
  return (
    <div className="relative">
      <button
        ...
        className="hover:bg-foreground/5 flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium transition-colors"
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="border-foreground/10 absolute right-0 top-full z-20 mt-2 w-40 rounded-lg border bg-background p-1 shadow-lg">
            {locales.map((loc) => (
              <button
                key={loc.code}
                onClick={() => switchLocale(loc.code)}
                className={`hover:bg-foreground/5 flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors ${

              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-foreground/70 mb-8">
                    Have questions? Reach out to us directly through any of these channels.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@elevatedigital.com" className="text-foreground/70 hover:text-primary transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-foreground/70">
                        Available worldwide for remote projects<br />
                        San Francisco, CA
                      </p>
                    </div>
                  </div>
                ...
                <div className="pt-8 border-t border-foreground/10">
                  ...
                  <div className="flex items-center gap-4">
                    <a
                      href="#"
                      className="w-10 h-10 bg-foreground/5 rounded-lg flex items-center justify-center hover:bg-primary/10 transition-colors"
                      aria-label="Twitter"
                    >
